...
export default function AppsPage() {
  ...
  // FIX: Set origin in useEffect to avoid hydration mismatch
  ...
  const handleGenerateTransferQR = async () => {
    ...
    try {
      ...
      setError('Invalid credential JSON format or encryption failed.');
    }
  };
    ...
    <div className="mx-auto max-w-4xl p-8 space-y-12">
      <section className="p-6 border rounded-lg shadow-sm bg-white">
        ...
        <div className="flex justify-center p-4 bg-white rounded-lg">
          {verifyDeepLink ? <QRCodeCanvas value={verifyDeepLink} size={256} fgColor="#000000" bgColor="#ffffff" /> : <div className="w-[256px] h-[256px]" />}
        </div>
      </section>
